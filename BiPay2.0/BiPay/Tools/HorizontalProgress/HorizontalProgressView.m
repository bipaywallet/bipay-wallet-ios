...
- (void)generatePointWithFrame:(CGRect)frame
    ...
    if (achievedFlag && aboveFlag) {
        ...
        pointView.backgroundColor = self.unachievedColor ? self.unachievedColor : lineColor;
    }
...
- (void)generateUnitLineWithFrame:(CGRect)frame
    ...
    if (achievedFlag && aboveFlag) {
        ...
        lineView.backgroundColor = self.unachievedColor ? self.unachievedColor : lineColor;
    }
