...
- (void)setupSubviews{
    ...
    if (KSGuaidManager.shouldDismissWhenDragging == NO) {
        ...
        [self.dismissButton setTitleColor:RGB(22, 32, 61, 1) forState:UIControlStateNormal];
        [self.dismissButton setBackgroundImage:[UIImage imageNamed:@"btnBackground"] forState:UIControlStateNormal];
        self.dismissButton.layer.cornerRadius = 24;
...
//        [self.dismissButton setImage:KSGuaidManager.dismissButtonImage forState:UIControlStateNormal];
        ...
        self.dismissButton.bounds = CGRectMake(0, 0, SCREEN_WIDTH - 160, 48);
