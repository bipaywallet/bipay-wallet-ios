...
- (IBAction)valuechange:(UISlider *)sender {
    ...
    if (self.fromCoinModel.fatherCoin) {//代币
        ...
        if ([self.fromCoinModel.recordType intValue]==0) {
            ...
            if ([self.fromCoinModel.brand isEqualToString:@"XNE"]||[self.fromCoinModel.brand isEqualToString:@"GCA"]||[self.fromCoinModel.brand isEqualToString:@"GCB"]||[self.fromCoinModel.brand isEqualToString:@"GCC"]||[self.fromCoinModel.brand isEqualToString:@"STO"]) {
